 ...
 * @type {Boolean}
 */
// export const TOUCH_ENABLED = Dom.isReal() && ('ontouchstart' in window || window.navigator.maxTouchPoints || (window.DocumentTouch && window.document instanceof window.DocumentTouch))
...
export const IS_IPAD = (/iPad/i).test(USER_AGENT) ||
  (IS_SAFARI && !(/iPhone/i).test(USER_AGENT))
